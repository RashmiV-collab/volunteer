 ...
 * Documentation:     https://www.approveme.com/wpesign-features/stand-alone-documents/
...
if(class_exists( 'WP_E_Addon' ))
{
	...
	$esign_addons->esign_update_check('63', '1.8.6');
}
...
esig_addon_includes( dirname( __FILE__ ) . '/public/esig-sad.php' );
esig_addon_includes( dirname( __FILE__ ) . '/includes/esig-sad-class.php' );
...
if (is_admin()) {
    ...
    esig_addon_includes( dirname( __FILE__ ) . '/admin/esig-sad-admin.php' );

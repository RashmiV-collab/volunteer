		...
		function render_suggested_extensions($current_post_type) {
			...
			<div class="remodal suggested-extensions-modal" data-remodal-id="modal-suggested-extensions" data-remodal-options="closeOnOutsideClick: false">
				...
				<div class="modal-content">
					...
					<p><?php _e('Do you need help?.', VGSE()->textname); ?> <a target="_blank" href="<?php echo VGSE()->get_support_links('contact_us', 'url', 'required-extension'); ?>"><?php _e('Contact us', VGSE()->textname); ?></a></p>
					...
					$buttons.each(function () {
						...
						$button.click(function (e) {
							...
							jQuery.post(apiUrl, {
								...
								if (response.success) {
									$button.addClass('disabled').text($button.data('success-text'));

...
class WP_E_Common extends WP_E_Model {
    ...
    public function esig_document_search_form() {
        ...
        $html .= '<input type="hidden" name="page" value="esign-docs"><input type="search" id="esig-document-search" class="esig_document_search" name="esig_document_search" style="min-width:250px;" placeholder="' . __("Document title or Signer name","esig") .'" value="' . esc_attr(ESIG_SEARCH_GET('esig_document_search')) . '">
...
//exit;
    ...
    public function esig_bulk_action_form() {
        ...
        if (in_array(esigget("id",$screen), $admin_screens)) {
            ...
            <option value="-1" selected="selected">' . __('Bulk Actions','esig') .'</option>';
    ...
    public function esig_latest_version() {
        ...
        $api_params = array(
            ...
            'license' => trim(Esign_licenses::get_license_key()),
            'name' => 'WP E-Signature',
    ...
    public function esig_get_timezone() {
        ...
        try {
            ...
            $dt = new DateTime("", new DateTimeZone($timezone_string));

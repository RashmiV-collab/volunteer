...
class WP_E_generalsController extends WP_E_appController {
    ...
    public function misc() {
        if (isset($_POST['misc-submit'])) {
            ...
            $this->view->setAlert(array('type' => 'alert e-sign-alert esig-updated', 'title' => '', 'message' => __('<strong>Well done</strong> : Your E-Signature General settings have been updated.', 'esig')));
        ...
        if ($this->settings->get_generic("esign_disable_back_button")) {
            $esign_disable_back_button = "checked";
        } else {
            $esign_disable_back_button = "";
        }
        ...
        $template_data = array(
            ...
            "esign_disable_back_button" => $esign_disable_back_button,
            "link_active" => $class,
    ...
    public function mails() {
        if (isset($_POST['mails-submit'])) {
            ...
            $this->view->setAlert(array('type' => 'alert e-sign-alert esig-updated', 'title' => '', 'message' => __('<strong>Well done </strong> : Your e-signature Emails settings have been updated.', 'esig')));

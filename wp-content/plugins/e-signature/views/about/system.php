...
Temp Directory:         <?php echo (is_writable(esigFiles::instance()->tempPath())? esigFiles::instance()->tempPath() . " (writable)" : "No") . "\n\n"; ?>
Active Add-ons:         <?php
...
GD library:              <?php echo (extension_loaded('gd') ? 'Supported' : 'Not Supported***') . "\n"; ?>

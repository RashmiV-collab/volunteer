<div id="wpem-export-modal-popup-venue-xml" class="wpem-modal" role="dialog" aria-labelledby="<?php _e('Venue xml Export','wp-event-manager-export');?>">
	<div class="wpem-modal-content-wrapper">
		<div class="wpem-modal-header">
			<div class="wpem-modal-header-title">
				<h3 class="wpem-modal-header-title-text"><?php _e('Venue xml Export','wp-event-manager-export');?></h3>
			</div>
		...
		<div class="wpem-modal-content">
			<a id="event_csv_default" href="?event_csv_default&user_id=<?php echo get_current_user_id(); ?>&file_type=xml" class="wpem-theme-button">
				<span>
					<i class="wpem-icon-download3"></i> 
					<?php _e('Default', 'wp-event-manager-export'); ?>
				</span>
			</a>
	 		<a id="custom_venue_xml" href="#" class="wpem-theme-button">
				<span>
			...
			<form action="" method="post" class="wpem-form-wrapper" id="custom_venue_xml_form" style="display:none;">
				...
				<div class="wpem-form-group">
				 	<fieldset class="wpem-form-group fieldset-venue_fields">
						...
						<div class="field">
							<select class="event-manager-select-chosen" id="event_manager_export_xml_venue_fields" name="event_manager_export_xml_venue_fields[]" multiple="multiple" required="true">
					 			<?php
							 ...
							 <input type="hidden" name="event_manager_custom_export_xml_venue_fields" id="event_manager_custom_export_xml_venue_fields" />

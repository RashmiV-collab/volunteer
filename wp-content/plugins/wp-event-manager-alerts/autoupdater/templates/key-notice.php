<div class="updated">
	...
	<p><?php printf( __('<a href="%1$s">Please enter your licence key</a> in the plugin list below to get updates for "%2$s".', 'wp-event-manager-alerts'), '#' . sanitize_title( $this->plugin_slug . '_licence_key_row' ), esc_html( $this->plugin_data['Name'] ) ); ?></p>

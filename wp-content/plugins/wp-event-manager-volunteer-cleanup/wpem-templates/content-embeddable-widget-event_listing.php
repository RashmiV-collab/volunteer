...
<li class="embeddable-event-widget-listing">
	<table>
<tr style="display: flex; padding: 20px;">
    <td>
    ...
    <td class="addFlex">
        <table width="100%" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-family: Arial, \'Helvetica Neue\', Helvetica, sans-serif; margin: 0; padding: 0; width: 100%;">
            ...
            <tr>
                <div class="wpem-event-date-time" style="margin: 5px 0px;  color: #555555;  display: flex;align-items: center;padding-left: 10px; ">
                   
                        <img width="20" height="20" src="<?php echo WPEM_VOLUNTEER_URI.'assets/img/clock-icon.png'; ?>" alt="-" style="width: auto;  height: 15px;"/><span class="wpem-event-date-time-text" style="font-size: 15px; line-height: 20px; padding-left: 10px; font-family: Roboto, Sans-serif;"> <?php display_event_start_date(); ?>
                                <?php
                                if (!empty($start_time)) {
            ...
            <tr>
                <div class="wpem-event-location" style="margin: 5px 0px;  color: #555555;  display: flex; align-items: center; padding-left: 10px; ">
                    
                    <img width="15" height="20" src="<?php echo WPEM_VOLUNTEER_URI.'assets/img/map-pointer.png'; ?>" alt="-" style="width: auto;
    height: 15px;padding-left:3px"/><span class="wpem-event-location-text" style="font-size: 15px; line-height: 20px; padding-left: 12px; font-family: Roboto, Sans-serif;"> <?php
            ...
            <tr>
                ...
                <?php if($all_tickets){ 
                    ...
                    <div style="display:block;width: 100%;margin:10px 0px">
                        ...
                        <span class="wpem-event-ticket-type-text" style="color: #111111; padding: 5px 7px; display: inline-block; line-height: 15px;  font-weight: 500; font-size: 14px; border-radius: 4px;margin-left:5px;"><?php echo '<span class="remaining-tickets-counter">';

                                                ...
                                                foreach ($additional_fields as $name => $field) : ?>
                                                    ...
                                                    <?php if (isset($field_value)) : ?>
                                                        ...
                                                        <?php if ($field['type'] == 'group') : ?>
                                                            ...
                                                            <?php endif; ?>
                                                        <?php elseif (($field['type'] == 'textarea' || $field['type'] == 'wp-editor') && !empty($field_value)) : ?>
                                                            <div class="wpem-col-12 wpem-additional-info-block-textarea">
                                                                <div class="wpem-additional-info-block-details-content-items">
                                                        ...
                                                        <?php elseif ($field['type'] == 'multiselect' && !empty($field_value)) : ?>
                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                <div class="wpem-additional-info-block-details-content-items">
                                                                    <?php
                                                                    $my_value_arr = [];
                                                        ...
                                                        <?php elseif ($field['type'] == 'select' && !empty($field_value)) : ?>
                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                <div class="wpem-additional-info-block-details-content-items">
                                                        ...
                                                        <?php elseif (isset($field['type']) && $field['type'] == 'date' && !empty($field_value)) : ?>
                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                <div class="wpem-additional-info-block-details-content-items">
                                                        ...
                                                        <?php elseif (isset($field['type']) && $field['type'] == 'time' && !empty($field_value)) : ?>
                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                <div class="wpem-additional-info-block-details-content-items">
                                                        ...
                                                        <?php elseif ($field['type'] == 'file' && !empty($field_value)) : 
                                                            if((is_array($field_value) && !empty($field_value[0])) || (!is_array($field_value) && !empty($field_value))):?>
                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'wp-event-manager'),  $field['label']); ?> - </strong></p>
                                                                <div class="wpem-additional-info-block-details-content-items wpem-additional-file-slider">
                                                            ...
                                                            <?php endif; ?>                  
                                                        <?php elseif ($field['type'] == 'url' && isset($field_value) && !empty($field_value)) : ?>
                                                            <div class="wpem-col-12 wpem-additional-info-block-textarea">
                                                                <div class="wpem-additional-info-block-details-content-items">
                                                                    <p class="wpem-additional-info-block-textarea-text dev__dcm"><a target="_blank" href="<?php if (isset($field_value)) echo esc_url($field_value); ?>"><?php printf(__('%s', 'wp-event-manager'),  $field['label']); ?></a></p>
                                                                </div>
                                                            </div>
                                                        <?php elseif ($field['type'] == 'radio' && array_key_exists('options',$field) && !empty($field_value)) : ?>
                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                <div class="wpem-additional-info-block-details-content-items">
                                                        ...
                                                        <?php elseif ($field['type'] == 'checkbox' && !empty($field_value)) : ?>
                                                            <div class="wpem-col-12 wpem-additional-info-block-textarea">
                                                                <div class="wpem-additional-info-block-details-content-items">
                                                        ...
                                                        <?php else : ?>
                                                            ...
                                                            <?php }else if (!is_array($field_value) && !empty($field_value)) { ?>
                                                                <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                    <div class="wpem-additional-info-block-details-content-items">

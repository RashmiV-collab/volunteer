<tr>
    ...
    <td>
        <input type="text" class="input-text" name="field_description[<?php echo esc_attr($index); ?>]" value="<?php echo esc_attr(isset($field['description']) ? $field['description'] : '' ); ?>" placeholder="<?php _e('N/A', 'wp-event-manager-guests'); ?>" />
    </td>
    <td class="field-options">
        <input type="text" class="input-text placeholder" name="field_placeholder[<?php echo esc_attr($index); ?>]" value="<?php echo esc_attr($field['placeholder']); ?>" placeholder="<?php _e('N/A', 'wp-event-manager-guests'); ?>" />

        <input type="text" class="input-text options" name="field_options[<?php echo esc_attr($index); ?>]" placeholder="<?php _e('Pipe (|) separate options.', 'wp-event-manager-guests'); ?>" value="<?php echo esc_attr(isset($field['options']) ? implode(' | ', $field['options']) : '' ); ?>" />

        ...
        <div class="wpem-event-guest-lists-body">
            ...
            <form class="wpem-event-guest-lists wpem-form-wrapper" method="POST">
                ...
                <div class="wpem-event-guest-lists-header">
                    <h2 class="wpem-form-title wpem-heading-text"><?php _e( 'Update Guest', 'wp-event-manager-guests' ); ?></h2> 
                </div>
                ...
                <div class="wpem-event-guest-lists-field">
                    ...
                    <?php foreach( $fields as $name => $field ) :
                        $field['value'] = get_post_meta($guest_id, $name, true);?>
                ...
                <div class="wpem-form-footer">
                    ...
                    <input type="hidden" name="event_id" value="<?php echo $guest->post_parent; ?>" />

                    <button type="submit" class="wpem-theme-button" name="wp_event_manager_send_guest" value="<?php esc_attr_e( 'Update Guest', 'wp-event-manager-guests' ); ?>"><?php _e('Update Guest','wp-event-manager-guests');?></button>

                    <?php wp_nonce_field( 'event_manager_send_guest' ); ?>
                </div>

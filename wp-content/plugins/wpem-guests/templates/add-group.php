    ...
    <div class="wpem-main wpem-event-guest-lists-wrapper">
        ...
        <form class="wpem-event-guest-lists wpem-form-wrapper" method="POST">
                <div class="wpem-event-guest-lists-header">
                    <h2 class="wpem-form-title wpem-heading-text"><?php _e( 'Add Group', 'wp-event-manager-guests' ); ?></h2> 
                </div>
                    ...
                    <div class="wpem-row">
                        ...
                        <div class="wpem-col-md-12">
                            <div class="wpem-form-group">
                                ...
                                <input type="text" name="group_name" id="group_name" required placeholder="<?php _e( 'Group name', 'wp-event-manager-guests' ); ?>" value="" />
                        ...
                        <div class="wpem-col-md-12">
                            <div class="wpem-form-group">
                                ...
                                <input type="text" name="group_description" id="group_description" placeholder="<?php _e( 'Group description', 'wp-event-manager-guests' ); ?>" value="" />
                                <small class="description"></small>
                            </div>                            
                        </div>
                        ...
                        <div class="wpem-col-md-12">
                            <div class="wpem-form-group multi-select-parent">
                                <label for="group_fields"><?php _e( 'Select fields', 'wp-event-manager-guests' ); ?><span class="require-field">*</span></label>
                                <select name="group_fields[]" id="group_fields"  class="event-manager-select-chosen multi-select" multiple="multiple" required>
                        ...
                        <div class="wpem-col-md-12">
                            <div class="wpem-form-group">
                                ...
                                <button type="submit" onclick="wp_event_manager_add_group" class="wpem-theme-button" name="wp_event_manager_add_group" value="<?php esc_attr_e( 'Save Group', 'wp-event-manager-guests' ); ?>"><?php _e('Save Group','wp-event-manager-guests');?></button>
